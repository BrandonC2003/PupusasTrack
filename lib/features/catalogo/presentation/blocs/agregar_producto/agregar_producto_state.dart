...
class AgregarProductoState extends Equatable {
    final String nombre;
    ...
    final AgregarProductoStatus status;
    ...
    const AgregarProductoState({
        ...
        this.status = AgregarProductoStatus.initial,
        this.errorMessage = '',
    });

    AgregarProductoState copyWith({
        String? nombre,
...
enum AgregarProductoStatus { initial, loading, success, failure }